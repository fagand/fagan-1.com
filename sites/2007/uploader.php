...
$limitedext = array(".gif",".jpg",".png",".jpeg",".zip",".bmp"); //Extensions you want files uploaded limited to. also you can use:  //array(".gif",".jpg",".jpeg",".png",".txt",".JPG",".nfo",".doc",".rtf",".htm",".JPG",".dmg",".zip",".rar");
